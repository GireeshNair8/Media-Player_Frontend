  ...
  return (
    ...
    <Row className='d-flex justify-content-center align-items-center'>
      ...
      <Col lg={5}>
        ...
        <p style={{textAlign:'justify'}} className='mt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum incidunt rem quam quidem atque. Aspernatur, corrupti enim similique veritatis inventore quam! Aperiam voluptatum cum omnis! Molestiae est eos ullam eaque!</p>
    ...
    <Card className='p-4' style={{ width: '22rem' }}>
      ...
      <Card.Body>
        <Card.Title>Catergorized Video</Card.Title>
        <Card.Text>
          Some quick example text to build on the card title and make up the
          bulk of the card's content.
        </Card.Text>
      ...
      <div className='container border border-2 rounded border-secondary p-5 mt-5 mb-5'>
        <Row>
          <Col lg={5}>
            ...
            <p><span className='fs-5 fw-bolder'>Play Everything</span>: Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime earum iste quia aperiam voluptas deserunt suscipit rerum molestiae, incidunt praesentium, nesciunt unde officia mollitia nam qui impedit pariatur facilis quae!</p>
            <p><span className='fs-5 fw-bolder'>Play Everything</span>: Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime earum iste quia aperiam voluptas deserunt suscipit rerum molestiae, incidunt praesentium, nesciunt unde officia mollitia nam qui impedit pariatur facilis quae!</p>
            <p><span className='fs-5 fw-bolder'>Play Everything</span>: Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime earum iste quia aperiam voluptas deserunt suscipit rerum molestiae, incidunt praesentium, nesciunt unde officia mollitia nam qui impedit pariatur facilis quae!</p>
          </Col>
          <Col></Col>
